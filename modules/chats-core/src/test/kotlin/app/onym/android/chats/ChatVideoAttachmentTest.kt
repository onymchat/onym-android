...
class ChatVideoAttachmentTest {
    ...
    // formatVideoDuration_formatsAsMinutesSeconds moved back to :app
    // (ChatVideoDurationFormatTest) — its subject is the internal UI
    // helper in ChatBubble.kt, which stays in the app's UI half.
}
