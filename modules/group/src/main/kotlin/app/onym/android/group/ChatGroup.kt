...
data class ChatGroup(
     ...
     * creator's own [app.onym.android.identity.Identity.stellarPublicKey].
     ...
     * length" — and [IntroCapability] rejects those, which would turn
     * "Share invite" into a permanent failure for exactly those groups.
     * Losing the rules from the link is bad; losing the ability to
     * invite anyone is worse.
     *
