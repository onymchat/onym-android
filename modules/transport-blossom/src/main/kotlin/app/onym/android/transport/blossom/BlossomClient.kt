...
class OkHttpBlossomClient(
    ...
    companion object {
        ...
        /** Hex SHA-256 of the stored bytes — the blob's Blossom
         *  address. Same digest `app.onym.android.chats.ChatImageCrypto.sha256Hex`
         *  computes; duplicated here (one line of `MessageDigest`) so
         *  the transport layer doesn't import `chats/`. */
