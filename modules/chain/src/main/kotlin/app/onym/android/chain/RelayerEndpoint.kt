 ...
 */
@Serializable
internal data class KnownRelayersDocument(
    val version: Int,
...
data class RelayerConfiguration(
     ...
     * the next [app.onym.android.chain.RelayerRepository.refresh])
    ...
    companion object {
         ...
         *  next [app.onym.android.chain.RelayerRepository.refresh]
 ...
 */
internal sealed class RelayersFetchError(message: String, cause: Throwable? = null) : Exception(message, cause) {
