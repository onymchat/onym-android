...
class CrossPlatformFixtureTest {
    ...
    companion object {
        ...
        // Fixture bytes from onym-ios's
        // IdentityRepositoryTests.test_derivation_matchesCrossPlatformFixture
        // (post-rebrand, salts: app.onym.bip39 + app.onym.ios).
    ...
    fun stellar_pubkey_and_account_id_match_ios() {
        // Derivation chain:
        //   mnemonic → seed → HKDF(seed, "app.onym.bip39", "nostr-secp256k1-v1") = nostrSecret
        //   nostrSecret → HKDF("app.onym.ios", "stellar-ed25519-v1") → Ed25519 seed
    ...
    fun x25519_pubkey_and_inbox_tag_match_ios() {
        ...
        //   nostrSecret → HKDF("app.onym.ios", "x25519-key-agreement-v1") → X25519 seed
