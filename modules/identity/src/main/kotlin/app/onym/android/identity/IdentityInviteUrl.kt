...
/** Base of the identity-invite App Link. Internal — the only
 *  consumer is [inviteUrl] above; the deeplink parser on the app
 *  side (`InviteKeyCanonicalizer`) matches the URL shape with its
 *  own constants. */
internal const val IDENTITY_INVITE_URL_BASE: String = "https://onym.app/i?k="
