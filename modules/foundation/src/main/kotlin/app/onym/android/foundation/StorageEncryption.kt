 ...
 * Keystore-backed loader through [fromContext] at app startup. The
 * ctor is public (not internal) because the Room store tests in the
 * consuming modules construct throwaway instances with per-test keys.
 *
 * Mirrors `StorageEncryption.swift` from onym-ios PR #16.
 */
class StorageEncryption(private val keySpec: SecretKeySpec) {
