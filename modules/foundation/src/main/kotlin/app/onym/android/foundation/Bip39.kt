...
object Bip39 {
     ...
     *
     *   HKDF-SHA256(seed, salt="app.onym.bip39", info="nostr-secp256k1-v1", L=32)
     *
     ...
     *
     *   HKDF-SHA256(seed, salt="app.onym.bip39", info="bls12-381-v1", L=32)
     *
    ...
    /** HKDF-SHA256 (RFC 5869). Used by both BIP39-seed and nostr-secret
     *  derivations, and by `IdentityRepository`'s downstream key
     *  stretches in `:app` — public since the module split (it was
     *  `internal` when repository and Bip39 shared the app module). */
    fun hkdfSha256(
        ikm: ByteArray,
        salt: ByteArray,
        info: ByteArray,
