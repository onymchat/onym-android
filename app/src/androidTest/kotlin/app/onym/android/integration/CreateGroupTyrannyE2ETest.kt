 ...
 *   -Pandroid.testInstrumentationRunnerArguments.class=app.onym.android.integration.CreateGroupTyrannyE2ETest
 * ```
 *
...
class CreateGroupTyrannyE2ETest {
    ...
    fun requireIntegrationGateAndRestoreIdentity() {
        ...
        identityStore = IdentitySecretStore(
            ...
            prefsFileName = "app.onym.android.identity.tests.e2e.${UUID.randomUUID()}",
        )
