 ...
 *   -Pandroid.testInstrumentationRunnerArguments.class=app.onym.android.integration.CreateGroupAnarchyE2ETest
 * ```
 *
...
class CreateGroupAnarchyE2ETest {
    ...
    fun requireIntegrationGateAndRestoreIdentity() {
        ...
        identityStore = IdentitySecretStore(
            ctx,
            prefsFileName = "app.onym.android.identity.tests.e2e.anarchy.${UUID.randomUUID()}",
        )
