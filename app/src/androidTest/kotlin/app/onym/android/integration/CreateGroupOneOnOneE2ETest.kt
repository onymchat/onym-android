 ...
 *   -Pandroid.testInstrumentationRunnerArguments.class=app.onym.android.integration.CreateGroupOneOnOneE2ETest
 * ```
 *
...
class CreateGroupOneOnOneE2ETest {
    ...
    fun requireIntegrationGateAndRestoreIdentity() {
        ...
        identityStore = IdentitySecretStore(
            ...
            prefsFileName = "app.onym.android.identity.tests.e2e.oneonone.${UUID.randomUUID()}",
        )
    ...
    private class E2EEnvironment(
        ...
        private val networkPreference: app.onym.android.chain.NetworkPreferenceProvider,
        private val proofGenerator: app.onym.android.chain.GroupProofGenerator,
