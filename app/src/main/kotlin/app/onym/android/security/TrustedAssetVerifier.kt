 ...
 */
class SignatureVerificationException(message: String) : IOException(message)
...
class TrustedAssetVerifier(
     ...
     * from "bad signature".
     */
    fun verify(asset: ByteArray, signature: ByteArray?): Result {
    ...
    companion object {
         ...
         */
        val SIGNING_PUBLIC_KEY: ByteArray = ByteArray(PUBLIC_KEY_LENGTH)
         ...
         */
        const val ENFORCE_SIGNATURES = false
