...
include(":moderation")
project(":moderation").projectDir = file("modules/moderation")
include(":push")
project(":push").projectDir = file("modules/push")
include(":moderation-ui")
project(":moderation-ui").projectDir = file("modules/moderation-ui")
include(":backup")
project(":backup").projectDir = file("modules/backup")
include(":backup-ui")
project(":backup-ui").projectDir = file("modules/backup-ui")
